...
// (in-package ros_basics_turorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'ros_basics_turorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('testvalue')) {
        this.testvalue = initObj.testvalue
      }
      else {
        this.testvalue = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [testvalue]
    bufferOffset = _serializer.int64(obj.testvalue, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [testvalue]
    data.testvalue = _deserializer.int64(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_basics_turorials/AddTwoIntsResponse';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ec044db28199a50e9e5ec5708bb4e921';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.testvalue !== undefined) {
      resolved.testvalue = msg.testvalue;
    }
    else {
      resolved.testvalue = 0
    }
...
module.exports = {
  ...
  md5sum() { return 'aa1aa1352f5bcf43b9b6f23761f75fd6'; },
  datatype() { return 'ros_basics_turorials/AddTwoInts'; }
};
